                    ...
                    <div class="row d-flex justify-content-center">
                        <div className="row ">                            
                            <div className="col-lg-4">
                                <Link to='/TuristaFood'><img  src='https://c.pxhere.com/photos/a1/58/breads_breakfast_delicious_egg_food_food_plating_fork_jam-959488.jpg!d' className="bd-placeholder-img rounded-circle" width="140" height="140" alt="Comida" />
</Link>
                                <h2>Comer</h2>
                            ...
                            <div className="col-lg-4">
                                <Link to='/TuristaActivity'>                                <img src='https://www.bubblefootball.es/wp-content/uploads/2016/01/aventura.jpg' className="bd-placeholder-img rounded-circle" width="140" height="140" alt="Actividad" />
</Link>
                                <h2>Hacer</h2>
                            ...
                            <div className="col-lg-4">
                               <Link to='/Itinerario'> <img src='https://image.freepik.com/vector-gratis/mapa-ruta-punteros-estilo-plano_23-2147783000.jpg' className="bd-placeholder-img rounded-circle" width="140" height="140" alt="Mapas" />
                                ...
                                <p><Link className="btn btn-info" to="/turista" role="button">Ir a</Link></p>                        </div>
                        </div>
                        <div className="col-lg-4">
                            ...
                            <p><Link className="btn btn-info" to="/Random" role="button">Ir a</Link></p>
                        </div>
                    </div>
                </div>
